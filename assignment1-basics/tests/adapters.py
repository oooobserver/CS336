...
def run_multihead_self_attention(
    ...
    mha = MultiHeadAttention(
        d_model=d_model, num_heads=num_heads, use_mask=True, device=in_features.device, dtype=in_features.dtype
    )
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    silu = Silu(device=in_features.device, dtype=in_features.dtype)
